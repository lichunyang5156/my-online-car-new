...
//  private static final BigDecimal rate= new BigDecimal("0.04645");
  ...
  public static void main(String[] args) {
    ...
    String downloadUrl="/Users/cherry/Documents/LCY/HK/提前还款计划/2024-05-06-22w.xlsx";
    BigDecimal totalAmount=new BigDecimal("231357.69");//总剩余贷款额
    int month= 71;//剩余还款月数
    BigDecimal monthAmount= new BigDecimal("3275.76");//当前月还款本金
    BigDecimal reduceMonthAmount= new BigDecimal("159.97");//减少月供方式，提前还款后，每月还款本金
    List<Repayment> currentPlanList = computeCurrentPlan(monthAmount, totalAmount, month);//当前还款计划
    totalAmount=totalAmount.subtract(new BigDecimal("220000"));//提前还款金额
